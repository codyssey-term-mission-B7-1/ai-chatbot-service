...
| #6 | 역할·개인별 기여 증빙 | README 역할표 · docs/commit-audit.md | 실제 개인 기여와 과거 PR의 원래 기록을 대조. 역할 기준의 저자 재배정으로 대체하지 않음. |
...
| #24 | PR·병합 증빙 | GitHub PR 기록 · 이 PR의 CI · 과거/현재 SHA 구분 | 실제 개인 기여와 과거 PR의 원래 기록을 대조. 역할 기준의 저자 재배정으로 대체하지 않음. |
...
| #31 | 문서·Git·PR 증빙 대조 | 정상 PR/CI 기록과 실제 기여 증빙 | 실제 개인 기여와 과거 PR의 원래 기록을 대조. 역할 기준의 저자 재배정으로 대체하지 않음. |
