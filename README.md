...
> 2026-09-08 기준, `origin/develop`(`9acffce`) 실측. 재현: `git shortlog -sne --no-merges origin/develop` (집계 규칙은 [docs/commit-audit.md](docs/commit-audit.md))
...
- 오픈 중인 PR(승인 대기): #61 `chat.js` Enter/IME 가드 복구(#60) · #62 세션·쿠키 보안 강화(#54–#59) · #63 FK/설정 위생(#51–#53)
