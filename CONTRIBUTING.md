...
과제의 개인별 유의미한 커밋/PR 요구는 실제 작업과 검증으로 확인한다. 의미 없는 커밋 분할·가짜 리뷰로 대체하지 않는다. 현재 역할 수 4/3/4/2가 “각자 3개” 기준을 충족하는지는 팀/원문 요구 확인이 필요하다.
...
- 표준 로그는 `docs/LOGGING.md`의 17종. 새 이벤트를 추가할 때 등록·목적·필드·테스트를 함께 갱신한다.
